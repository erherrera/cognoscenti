...
public class FolderAccessHelper {
    ...
    */
    ...
    public void attachDocument(ResourceEntity remoteFile,
            NGPage ngp,        String comment,   String dName,
...
*/
    ...
    public static void initLocalConnections(){
        loaclConnections = new Vector<LocalFolderConfig>();
        String lclConn = ConfigFile.getProperty("localConnections");
        if(lclConn == null){
            return;
        }
    ...
    public static void initCVSConnections(){
        cvsConnections = new Vector<CVSConfig>();
        String cvsConn = ConfigFile.getProperty("cvsConnections");
        if(cvsConn == null){
            return;
        }
    ...
    */
    public boolean createCopyInRepository(String userkey, NGPage ngp, String aid,
        ...
        UserPage up = UserPage.findOrCreateUserPage(userkey);
