...
public class SectionDef
{
    ...
    */
    ...
    private static void initialize()
    {
        ...
        SectionFormat cannonComments =   new SectionComments();
        ...
        allDefs.add(new SectionDef(cannonComments, "Comments", MEMBER_ACCESS, MEMBER_ACCESS,
                                   false, "Notes", true));
        ...
        allDefs.add(new SectionDef(cannonComments, "Public Comments", ANON_ACCESS, PUBLIC_ACCESS,
