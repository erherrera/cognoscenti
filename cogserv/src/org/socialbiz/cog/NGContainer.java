...
public interface NGContainer
{
    ...
    */
    public NGRole getRole(String name) throws Exception;
    ...
    */
    public NGRole getRoleOrFail(String name) throws Exception;


    public NGRole createRole(String roleName, String description) throws Exception;
