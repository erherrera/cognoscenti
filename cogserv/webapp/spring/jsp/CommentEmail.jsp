        ...
        <div class="generalContent">
            <form name="emailForm" id="emailForm" action="<%=ar.retPath%>t/CommentEmailAction.form"
                ...
                <div style="float:right">
                     <input type="submit" name="action" id="action" class="inputBtn" value="Send Mail"  />
                     <input type="submit" name="action" id="action" class="inputBtn" value="Preview Mail" />
                </div>
