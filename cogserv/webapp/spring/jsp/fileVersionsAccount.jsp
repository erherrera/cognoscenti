...
%><%@ include file="/spring/jsp/EditAttachmentAccount.jsp"
...
<div class="content tab01">
    ...
    <div class="scrollableOverflow">
        ...
        <form action="editAttachment.form" enctype="multipart/form-data" method="post">
            <button type="submit"  class="inputBtn"  name="action" value="Cancel"><fmt:message key='nugen.button.general.goback'/></button>
        </form>
    </div>
</div>
