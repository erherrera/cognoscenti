...
%></a>
            ...
            ar.flush();
            //generatePage("member.htm",     "leaf_member.jsp",     aPage, projectFolder, ar);
            //generatePage("private.htm",    "leaf_private.jsp",    aPage, projectFolder, ar);
            //generatePage("admin.htm",      "leaf_admin.jsp",      aPage, projectFolder, ar);
            //generatePage("permission.htm", "leaf_permission.jsp", aPage, projectFolder, ar);
            ...
            ar.flush();
            //generatePage("status.htm",     "leaf_status.jsp",     aPage, projectFolder, ar);
            generatePage("history.htm",    "leaf_history.jsp",    aPage, projectFolder, ar);

            //generateNewPage("/t/{account}/{project}/admin.htm", aPage, siteBase, ar);
            ar.flush();
