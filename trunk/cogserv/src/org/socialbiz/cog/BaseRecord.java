...
public class BaseRecord extends DOMFace
{
    ...
    public final static int STATE_REVIEW    = 7;
    ...
    public final static String STATE_REVIEW_STR    = "Review";
    ...
    public final static String STATE_ERROR_IMG     = "ts_error.gif";
    public final static String STATE_UNSTARTED_IMG = "ts_initial.gif";
    public final static String STATE_STARTED_IMG   = "ts_offered.gif";
    public final static String STATE_ACCEPTED_IMG  = "ts_accepted.gif";
    public final static String STATE_WAITING_IMG   = "ts_waiting.gif";
    public final static String STATE_SKIPPED_IMG   = "ts_skipped.gif";
    public final static String STATE_COMPLETE_IMG  = "ts_completed.gif";
    public final static String STATE_REVIEW_IMG    = "ts_review.gif";
    public final static String STATE_FROZEN_IMG    = "ts_frozen.gif";
    public final static String STATE_DELETED_IMG   = "ts_deleted.gif";
    public final static String STATE_UNKNOWN_IMG   = "ts_unknown.gif";
    ...
    public static String stateImg(int state)
    {
        ...
        {
            case STATE_ERROR:
                return STATE_ERROR_IMG;
            case STATE_UNSTARTED:
                return STATE_UNSTARTED_IMG;
            case STATE_STARTED:
                return STATE_STARTED_IMG;
            case STATE_ACCEPTED:
                return STATE_ACCEPTED_IMG;
            case STATE_WAITING:
                return STATE_WAITING_IMG;
            case STATE_COMPLETE:
                return STATE_COMPLETE_IMG;
            case STATE_SKIPPED:
                return STATE_SKIPPED_IMG;
            case STATE_REVIEW:
                return STATE_REVIEW_IMG;
            case STATE_FROZEN:
                return STATE_FROZEN_IMG;
            case STATE_DELETED:
                return STATE_DELETED_IMG;
            default:
        }
        return STATE_UNKNOWN_IMG;
    }
    ...
    */
        ...
        throws Exception
    {
        ...
        return (LicenseRecord) getChild("license", LicenseRecord.class);
    }
