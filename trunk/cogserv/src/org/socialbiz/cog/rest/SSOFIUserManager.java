...
public class  SSOFIUserManager implements org.workcast.ssoficlient.interfaces.UserManager {
    ...
    * This means that the provider has to have a specific form:  theopenid URL
    ...
    */
    ...
    public SSOFIUserManager() {
        ...
        emailProviderAddress = ConfigFile.getProperty("emailOpenIDProvider");
    }
