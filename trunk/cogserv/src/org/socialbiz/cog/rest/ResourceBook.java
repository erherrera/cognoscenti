...
public class ResourceBook implements NGResource
{
    ...
    public ResourceBook(String serverURL, AuthRequest ar)
    {
    ...
    public void update()throws Exception
    {
        ...
        updateBook(ngb);
        ngb.saveFile(lar, "ResourceBook modification 2");
    ...
    public void updateuser()throws Exception
    {
        ...
        ngb.saveFile(lar, "ResourceBook modification 1");
        ...
        throws Exception
    {
        ...
        String methodname = lar.req.getMethod();
