...
/**
* At the root of a DOM tree is a node that has no parent, and that
* is the root node for an XML file on disk.
*
* DOMFile is a subclass of DOMFace, with the additional capabilities
...
public class DOMFile extends DOMFace
{
        ...
        throws Exception
    {
        ...
        {
            throw new NGException("nugen.exception.unable.to.read.create.xml.file", new Object[]{path}, e);
        }
    }
        ...
        throws Exception
    {
        ...
        {
            throw new NGException("nugen.exception.unable.to.write.file", new Object[]{associatedFile}, e);
        }
    }
        ...
        throws Exception
    {
        ...
        // if there are no elements, then don't modify anything ... it is a data value
        if (!hasChildElements)
        {
            return;
        }
        ...
        // To accomplish this, all Elements are removed from the parent and placed
        // in a vector for temporary holding, and all the existing text nodes are destroyed.
        // Once the parent is empty, the correct indenting nodes are added between
        // the Element nodes.
        ...
        {
            throw new ProgramLogicError("just cleaned out child nodes, but there seems to still be one.");
        }
        childNdList = parent.getChildNodes();
        if (childNdList.getLength()>0)
        {
            throw new ProgramLogicError("just cleaned out child nodes, but there seems to still be one in childlist.");
        }
    ...
    /**
    * use DOMElementComparator to sort a vector of elements into
