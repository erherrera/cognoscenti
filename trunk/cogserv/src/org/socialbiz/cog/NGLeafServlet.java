    ...
    private void doAuthenticatedGet(AuthRequest ar)  throws Exception {
        ...
        try {
            ...
            if (ngpi == null) {
                ...
                ngpi = NGPageIndex.getContainerIndexByKey(pageid);
                if (ngpi == null) {
            ...
            if (resource.equals("author.htm")) {
                // this is DEPRECATED. "author.htm" should be changed to
                // "admin.htm"
                // keeping this for legacy links that might have been made
