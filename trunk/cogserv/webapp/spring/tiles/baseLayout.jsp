...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript" src="<%=ar.baseURL%>jscript/interface.js"></script>
        ...
        <script type="text/javascript" language="javascript" src="<%=ar.baseURL%>jscript/TabbedPanels.js"></script>
