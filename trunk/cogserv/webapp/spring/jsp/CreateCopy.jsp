            ...
            <form name="CreateCopyForm" id="CreateCopyForm" action="CreateCopyForm.form" method="post">
                ...
                <table border="0px solid red" class="linkWizard">
                    ...
                    <tr>
                        ...
                        <td style="width:20px;"></td>
                        <td>
                            <button class="inputBtn" value="Create Copy" onclick="submitCreateCopyForm('ChooseFolder')">
                    ...
                    <tr>
                        <td class="linkWizardContent"></td>
                        <td style="width:20px;"></td>
                        <td><button class="inputBtn" value="Create connection" onclick="submitCreateCopyForm('CreateNewConnection')">
                    ...
                    <tr>
                        <td class="linkWizardContent"></td>
                        <td style="width:20px;"></td>
                        <td><input type="button" class="inputBtn" value="Ok" onclick="submitCreateCopyForm('ChooseDefLocation')"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="linkWizardContent"></td>
