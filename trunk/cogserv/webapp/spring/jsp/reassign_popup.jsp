...
*/
    ...
    status.put(0, "ts_error.gif");
    status.put(1, "ts_initial.gif");
    status.put(2, "ts_offered.gif");
    status.put(3, "ts_accepted.gif");
    status.put(4, "ts_waiting.gif");
    status.put(5, "ts_completed.gif");
    status.put(6, "ts_skipped.gif");
    status.put(7, "ts_review.gif");
                ...
                <form name="createTaskForm" action="reassignTaskSubmit.form" method="post" onsubmit="return onFormSubmit();">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            &nbsp;<input type="submit" value="Reassign" class="inputBtn" tabindex=3 /></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
