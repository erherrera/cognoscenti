...
<script type="text/javascript" language="javascript">
    ...
    function inviteUser(bookId,pageId,emailId)
    {
        if(isfreezed == 'false'){
            ...
            return openFreezePopup('No Profile found for this id and you can not invite user in this project because this project has been frozen by administrator/owner.');
        }
    }
                        ...
                        <td colspan="3">
                            <table id="assignTask" style="display:none">
                                ...
                                <tr>
                                    ...
                                    <td width="39" style="width:20px;"></td>
                                    <td><input type="text" class="inputGeneralSmall" style="width:368px" size="50" name="dueDate" id="dueDate"  value="" readonly="1" tabindex=6/>
