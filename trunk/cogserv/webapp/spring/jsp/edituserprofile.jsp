            ...
            <form id="upload_user" action="uploadImage.form" method="post" enctype="multipart/form-data">
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><input type="button" class="inputBtn" value="Upload Photo" onclick="javascript:uploadUserPhoto();"/></td>
                    </tr>
                </table>
            </form>
            <form id="updateUserProfile" name="updateUserProfile" action="EditUserProfileAction.form" method="post">
                ...
                <table border="0px solid red" width="100%">
                    ...
                    <tr>
                        <td class="gridTableColummHeader_2"></td>
                        <td style="width:20px;"></td>
                        <td colspan="2"><input type="button" class="inputBtn" onclick="updateProfile('Save')" value="Update Personal Details"/></td>
                    </tr>
                    <tr><td style="height:30px"></td></tr>
                    ...
                    <tr>
                        <td class="gridTableColummHeader_2"></td>
                        <td style="width:20px;"></td>
                        <td colspan="2"><input type="button" class="inputBtn" value="Change Preferred Email" onclick="updateProfile('UpdatePreferredEmail')"/></td>
                    </tr>
                    ...
                    <tr>
                        <td class="gridTableColummHeader_2"></td>
                        <td style="width:20px;"></td>
                        <td colspan="2"><input type="button" class="inputBtn" onclick="return addEmailId(<%ar.writeQuote4JS(emailList);%>);" value="Add New Email"/></td>
                    </tr>
                    <tr><td style="height:30px"></td></tr>
            ...
            <form id="updateOpenIdForm" name="updateOpenIdForm" action="<%=ar.retPath%>t/openIdLogin.form" method="post">
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td class="gridTableColummHeader_2"></td>
                        <td style="width:20px;"></td>
                        <td colspan="2"><input type="button" class="inputBtn" onclick="updateProfile('Cancel')" value="Go Back To My Settings"/></td>
                    </tr>
                </table>
            </form>
        </div>
            ...
            '<div class="generalPopupSettings">'+
                ...
                '<table> '+
                    ...
                    '<tr>'+
                        ...
                        '<td style="width:20px;"></td>'+
                        '<td>'+
                        //'<input type="button" name="option" class="inputBtn" value="Add Email" onclick="goForConfirmation(\''+option+'\',\''+email+'\',document.getElementById(\'confkey\'))">'+
