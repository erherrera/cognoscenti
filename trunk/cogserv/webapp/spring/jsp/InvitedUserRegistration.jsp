            ...
            <td valign="bottom" style="width:300px" align="center">
                ...
                <div class="loginBox">
                    <table>
                        <tr>
                            <td style="padding:20px;">
                               <input type="button" class="inputBtn" value="Add this email to existing profile" onclick="gotoAdd();"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:20px;">
                                <input type="button" class="inputBtn" value="Don't claim the address, Just go to project page" onclick="gotoproject();"/>
                            </td>
                        </tr>
                    </table>
                </div>
