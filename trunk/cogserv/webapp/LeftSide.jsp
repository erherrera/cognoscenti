        ...
        <div class="box">
            ...
            <div class="box_body">
                ...
                if (ar.isLoggedIn())
                {
                    ...
                    ar.write("- <a href=\"");
                    ar.write(ar.retPath);
                    ar.write("MyTaskList.jsp?u=");
                    ar.writeHtml(uProf.getKey());
                    ar.write("\" title=\"home for the logged in user\">My Goals</a><br/>\n");
                    ar.write("- <a href=\"");
                    ar.write(ar.retPath);
...
<%
        ...
        if (hookedLink!=null)
        {
            NGPageIndex ngpi = NGPageIndex.getContainerIndexByKey(hookedLink);
            if (ngpi!=null)
            {
...
if (ngsession!=null)
{
    ...
    {
        NGPageIndex ngpi = NGPageIndex.getContainerIndexByKey(rue.key);
        if (ngpi!=null)
        {
            ngpi.writeTruncatedLink(ar, 20);
            ar.write("<br/>\n");
        ...
        <div class="box">
            ...
            <div class="box_body">
                ...
                <%
                    ...
                    ar.write("<a href=\"");
                    ar.write(ar.retPath);
                    ar.write("p/main/public.htm\">Main</a>\n");
                    ar.write("</li>");
                    ...
                    if (up != null)
                    {
                        ...
                        ar.write("<a href=\"");
                        ar.write(ar.retPath);
                        ar.writeHtml(up.getHomePage());
                        ar.write("\">Home Page</a>\n");
                        ar.write("</li>");
...
%>
    <div class="box">
        ...
        <div class="box_body">
            <ul>
<%
    NGPageIndex ngpi = NGPageIndex.getContainerIndexByKey(ngp.getKey());
